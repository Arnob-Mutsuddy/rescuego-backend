...
-- CreateIndex
CREATE UNIQUE INDEX "DriverLocation_driverId_createdAt_key" ON "DriverLocation"("driverId", "createdAt");
...
-- CreateIndex
CREATE UNIQUE INDEX "Review_emergencyRequestId_key" ON "Review"("emergencyRequestId");
...
-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_emergencyRequestId_fkey" FOREIGN KEY ("emergencyRequestId") REFERENCES "EmergencyRequest"("id") ON DELETE CASCADE ON UPDATE CASCADE;
